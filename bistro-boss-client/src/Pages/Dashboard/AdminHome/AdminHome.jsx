...
const AdminHome = () => {
    ...
    const chartData = [
        { count: 3, category: "pizza", total: 39.7 },
        { count: 3, category: "dessart", total: 40.7 },
        { count: 11, category: "salad", total: 137.1 },
        { count: 3, category: "drinks", total: 44.4 },
        { count: 4, category: "soup", total: 54.4 }
    ]
    ...
    return (
        <div className='w-full m-4'>
            <h2 className='text-3xl font-bold font-sans'>Hi!, {user?.displayName}</h2>
